...
class DataTransformation:
    ...
    def get_data_transformaer_object(self)->Pipeline:
        """it initialises a KNNImputer object with the parameter specified in the training_pipline.py file and returns a Pipline object as the first step.
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initiate_data_transformation method of DataTransfomration class")
        try:
