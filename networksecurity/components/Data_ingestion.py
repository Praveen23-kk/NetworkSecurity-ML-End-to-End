...
class DataIngestion:
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            ...
            logging.info("Performace train test split on the dataframe")
            
            logging.info(
                "Exicted split_data_as_train_test method of Data_ingestion class"
            ...
            logging.info(f"Exported train and test filr path")
